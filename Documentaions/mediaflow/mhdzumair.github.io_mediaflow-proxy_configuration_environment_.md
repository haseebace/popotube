---
url: "https://mhdzumair.github.io/mediaflow-proxy/configuration/environment/"
title: "Environment variables - MediaFlow Proxy"
---

[Skip to content](https://mhdzumair.github.io/mediaflow-proxy/configuration/environment/#environment-variables)
...
- `FORWARDED_ALLOW_IPS`: Optional. Controls which IP addresses are trusted to provide forwarded headers (X-Forwarded-For, X-Forwarded-Proto, etc.) when MediaFlow Proxy is deployed behind reverse proxies or load balancers. Default: `127.0.0.1`. See [Forwarded Headers Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#forwarded-headers-configuration) for detailed usage.
