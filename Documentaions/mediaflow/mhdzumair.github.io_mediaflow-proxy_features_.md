---
url: "https://mhdzumair.github.io/mediaflow-proxy/features/"
title: "Features - MediaFlow Proxy"
---

[Skip to content](https://mhdzumair.github.io/mediaflow-proxy/features/#features)
...
Table of contents
  ...
  - [Stream Processing](https://mhdzumair.github.io/mediaflow-proxy/features/#stream-processing)
  - [Proxy & Routing](https://mhdzumair.github.io/mediaflow-proxy/features/#proxy-routing)
  - [Xtream Codes (XC) API Proxy](https://mhdzumair.github.io/mediaflow-proxy/features/#xtream-codes-xc-api-proxy)
  - [Acestream Proxy](https://mhdzumair.github.io/mediaflow-proxy/features/#acestream-proxy)
  - [Telegram MTProto Proxy](https://mhdzumair.github.io/mediaflow-proxy/features/#telegram-mtproto-proxy)
  - [Security](https://mhdzumair.github.io/mediaflow-proxy/features/#security)
  - [On-the-fly Transcoding](https://mhdzumair.github.io/mediaflow-proxy/features/#on-the-fly-transcoding)
  - [Additional Features](https://mhdzumair.github.io/mediaflow-proxy/features/#additional-features)
  - [DASH/MPD Support Status](https://mhdzumair.github.io/mediaflow-proxy/features/#dashmpd-support-status)

    - [MPD Segment Addressing Types](https://mhdzumair.github.io/mediaflow-proxy/features/#mpd-segment-addressing-types)
    - [MPD Presentation Types](https://mhdzumair.github.io/mediaflow-proxy/features/#mpd-presentation-types)
    - [DRM/Encryption Support](https://mhdzumair.github.io/mediaflow-proxy/features/#drmencryption-support)
    - [IV Size Support](https://mhdzumair.github.io/mediaflow-proxy/features/#iv-size-support)
    - [Multi-Key Support](https://mhdzumair.github.io/mediaflow-proxy/features/#multi-key-support)

  - [Pre-buffering (HLS & DASH)](https://mhdzumair.github.io/mediaflow-proxy/features/#pre-buffering-hls-dash)

    - [How Pre-buffering Works](https://mhdzumair.github.io/mediaflow-proxy/features/#how-pre-buffering-works)
    - [Key Behaviors](https://mhdzumair.github.io/mediaflow-proxy/features/#key-behaviors)
...
- **ClearKey DRM decryption** with support for all CENC encryption modes (see [DASH/MPD Support Status](https://mhdzumair.github.io/mediaflow-proxy/features/#dashmpd-support-status))
