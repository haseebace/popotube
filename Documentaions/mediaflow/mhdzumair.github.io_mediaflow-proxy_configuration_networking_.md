---
url: "https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/"
title: "Networking & reverse proxies - MediaFlow Proxy"
---

[Skip to content](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#networking-transport-forwarded-headers-reverse-proxies)
...
Configuration
  ...
  - [ ]
    ...
    - [Transport Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#transport-configuration)

      - [Basic Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#basic-configuration)
      - [Advanced Routing Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#advanced-routing-configuration)
      - [Route Configuration Options](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#route-configuration-options)
      - [Configuration Examples](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#configuration-examples)

    - [Forwarded Headers Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#forwarded-headers-configuration)

      - [What are Forwarded Headers?](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#what-are-forwarded-headers)
      - [Security Importance](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#security-importance)
      - [Configuration Options](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#configuration-options)
      - [Common Deployment Scenarios](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#common-deployment-scenarios)
      - [Best Practices](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#best-practices)
      - [Troubleshooting](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#troubleshooting)
      - [Example Nginx Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#example-nginx-configuration)

    - [Reverse Proxy Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#reverse-proxy-configuration)

      - [Nginx Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#nginx-configuration)
      - [Nginx Proxy Manager Configuration](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#nginx-proxy-manager-configuration)
      - [Important Notes for Nginx Proxy Manager](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#important-notes-for-nginx-proxy-manager)
      - [Troubleshooting Reverse Proxy Issues](https://mhdzumair.github.io/mediaflow-proxy/configuration/networking/#troubleshooting-reverse-proxy-issues)
...
\- `proxy_url`: Optional specific proxy URL for this route (overrides primary proxy\_url)
